...
- Add portable reviewer bundle: static HTML/JSON package with selected artifacts, previews, notes, hashes, and no original image. Status: bundle now emits `rapidtriage-reviewer.html`, Markdown/HTML/DOCX report exports, JSON/report/hash manifest, and archive hashes.
