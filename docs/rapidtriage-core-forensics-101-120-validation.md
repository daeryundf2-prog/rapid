...
| --- | --- | --- |
| #101-#104 Packaging/update | Release scripts generate portable ZIP, release manifest, packaging plan, update manifest, checksums, platform evidence gates, #101 Windows signing evidence manifest hashes/slots, #102 macOS notarization evidence manifest hashes/slots, #103 Linux package evidence manifest hashes/slots, #104 auto-update evidence manifest hashes/slots, trusted signing/notarization/package/update diff placeholders, and explicit blockers. | Real signed Windows installer, notarized macOS package, deb/rpm/AppImage builds, hosted signed update channel, fresh host smoke logs, and trusted release attestation manifests. |
