...
- Generated at: `2026-05-11T03:51:14.467920+00:00`
- Platform: `macOS-15.7.4-arm64-arm-64bit`
- Internal roadmap score: `100/100`
- Commercial readiness score: `79/100`
...
- `core-forensics-001-evtx-binxml-fixture` (tests.windows_artifact_fixtures EVTX fixtures): status `pass`
- `core-forensics-002-evtx-message-fixture` (tests.windows_artifact_fixtures EVTX fixtures): status `pass`
- `core-forensics-003-evtx-recovery-fixture` (tests.windows_artifact_fixtures EVTX corrupt/slack fixtures): status `pass`
- `core-forensics-004-registry-tree-fixture` (tests.windows_artifact_fixtures minimal registry hive): status `pass`
- `core-forensics-005-registry-deleted-fixture` (tests.windows_artifact_fixtures minimal registry hive): status `pass`
- `core-forensics-006-sam-security-system-fixture` (tests.windows_artifact_fixtures.build_windows_artifact_fixture): status `pass`
- `core-forensics-007-amcache-fixture` (tests.windows_artifact_fixtures.build_windows_artifact_fixture): status `pass`
- `core-forensics-008-shimcache-fixture` (tests.windows_artifact_fixtures.build_windows_artifact_fixture): status `pass`
- `core-forensics-009-bam-dam-fixture` (tests.windows_artifact_fixtures.build_windows_artifact_fixture): status `pass`
- `core-forensics-010-srum-fixture` (tests.windows_artifact_fixtures.build_windows_artifact_fixture): status `pass`
- `core-forensics-011-windows-edb-fixture` (tests.windows_artifact_fixtures.build_windows_artifact_fixture): status `pass`
- `core-forensics-012-mft-fixture` (tests.windows_artifact_fixtures.build_windows_artifact_fixture): status `pass`
- `core-forensics-013-usn-fixture` (tests.windows_artifact_fixtures.build_windows_artifact_fixture): status `pass`
- `core-forensics-014-jumplist-fixture` (tests.windows_artifact_fixtures.build_windows_artifact_fixture): status `pass`
- `core-forensics-015-shellbags-fixture` (tests.windows_artifact_fixtures.build_minimal_shellbags_registry_hive): status `pass`
- `core-forensics-016-prefetch-fixture` (tests.windows_artifact_fixtures.build_windows_artifact_fixture): status `pass`
- `core-forensics-017-lnk-fixture` (tests.windows_artifact_fixtures.build_windows_artifact_fixture): status `pass`
- `core-forensics-018-system-fixture` (tests.windows_artifact_fixtures.build_windows_artifact_fixture): status `pass`
- `core-forensics-019-browser-storage-fixture` (tests.windows_artifact_fixtures.build_windows_artifact_fixture): status `pass`
- `core-forensics-020-browser-timeline-fixture` (tests.windows_artifact_fixtures.build_windows_artifact_fixture): status `pass`
