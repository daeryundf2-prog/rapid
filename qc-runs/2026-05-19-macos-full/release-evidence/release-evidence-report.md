...
- Result: PASS
- Generated: `2026-05-19T00:24:41.897479+00:00`
...
- Dependency monitoring JSON: `/Users/shinyoohag/rapidforensic/repo/qc-runs/2026-05-19-macos-full/ops-security/dependency-monitoring.json`
...
| dependency-monitoring-json | pass | file present | `/Users/shinyoohag/rapidforensic/repo/qc-runs/2026-05-19-macos-full/ops-security/dependency-monitoring.json` |
| dependency-monitoring-payload | pass | command=dependency-monitoring, commercial_gap_ids=['#120'] | `/Users/shinyoohag/rapidforensic/repo/qc-runs/2026-05-19-macos-full/ops-security/dependency-monitoring.json` |
| dependency-monitoring-ci-workflow | pass | configured=True, passed_checks=['workflow_file_exists', 'scheduled_trigger', 'manual_trigger', 'pull_request_dependency_paths', 'check_dependencies_invoked', 'artifact_upload_configured', 'sbom_archived_in_dependency_artifact', 'read_only_permissions'] | `/Users/shinyoohag/rapidforensic/repo/qc-runs/2026-05-19-macos-full/ops-security/dependency-monitoring.json` |
| dependency-monitoring-sbom-hash | pass | sbom_hash=d6bb327524f80e47654b649b5f0fececd3ca87924aee46a79f648c09c68cf93e, manifest_hash=00e2fb10f37e8963b37e8fe46525ef1a1c089d2794e1355b13d86b39a524d42d | `/Users/shinyoohag/rapidforensic/repo/qc-runs/2026-05-19-macos-full/ops-security/dependency-monitoring.json` |
| dependency-monitoring-release-policy | pass | release_policy=Block release on known exploitable high/critical dependency issues unless a documented exception is approved. | `/Users/shinyoohag/rapidforensic/repo/qc-runs/2026-05-19-macos-full/ops-security/dependency-monitoring.json` |
| dependency-monitoring-limitation-preserved | pass | trusted_diff_status=missing, blockers=['artifact-checksum-linkage-required', 'ci-advisory-run-log-required', 'dependency-exception-review-required', 'high-critical-triage-required', 'independent-dependency-review-required', 'release-host-dependency-smoke-required', 'sbom-publication-required', 'scanner-version-lock-required', 'trusted-dependency-advisory-sbom-diff-missing'] | `/Users/shinyoohag/rapidforensic/repo/qc-runs/2026-05-19-macos-full/ops-security/dependency-monitoring.json` |
