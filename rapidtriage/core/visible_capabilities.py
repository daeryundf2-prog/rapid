...
CAPABILITY_GROUPS: tuple[dict[str, Any], ...] = (
    {
        ...
        "capabilities": (
            ...
            },
            {
                ...
                "status": "partial",
                "artifact_types": ("forensic-container-workflow",),
                "terms": (
                    "ad1",
                    "l01",
                    "aff",
    ...
    },
    {
        ...
        "capabilities": (
            {"id": "eventlog-chunk", "label": "EVTX chunk/record", "status": "partial", "terms": ("evtx", "eventlog", "record", "chunk")},
            {
                ...
                "status": "partial",
                "artifact_types": ("eventlog-event", "eventlog-summary"),
                "terms": (
                    "provider",
                    "manifest",
                    "message",
            ...
            },
            {
                ...
                "status": "partial",
                "artifact_types": ("eventlog-record-candidate", "eventlog-chunk", "eventlog-summary"),
                "terms": (
                    "deleted",
                    "corrupt",
                    "slack",
            ...
            },
            {
                ...
                "status": "partial",
                "artifact_types": ("eventlog-event", "eventlog-detection"),
                "terms": (
                    "usb-device-event",
    ...
    },
    {
        ...
        "capabilities": (
            ...
            {
                "id": "docs-index-citation-review",
                "label": "Docs-index hit citation/review 연결",
                "status": "usable",
                "artifact_types": ("docs-index", "docs-index-search", "report-citation"),
                "terms": (
                    "docs-index",
            ...
            {
                "id": "current-file-search-resume",
                "label": "현재 파일 검색 cursor/resume",
                "status": "usable",
                "artifact_types": ("search-hit", "source-search"),
                "terms": (
                    "source-search",
                    "source-search-full-cursor-scan-contract-v1",
                    "source-search-sqlite-resume-v1",
                    "source-search-file-resume-v1",
                    "sqlite_resume_token",
                    "file_resume_token",
                    "document_extraction_limits",
                    "limits_visible_to_gui",
                    "Continue SQLite search",
                    "Continue large file search",
                ),
            },
            {"id": "sqlite-table-viewer", "label": "SQLite table viewer", "status": "usable", "terms": ("sqlite", "database", "table", "row")},
            {
                "id": "sqlite-sidecar-wal-preview",
                "label": "SQLite WAL/SHM sidecar preview",
                "status": "usable",
                "artifact_types": ("sqlite-sidecar-preview", "sqlite-wal-preview"),
                "terms": (
                    "sqlite",
                    "wal",
                    "shm",
                    "journal",
                    "source-sqlite-wal-preview",
                    "sqlite-sidecar-preview",
            ...
            {"id": "email-eml-mbox", "label": "EML/MBOX 메일", "status": "partial", "terms": ("email", "eml", "mbox", "attachment")},
            {
                ...
                "status": "partial",
                "artifact_types": ("archive-file-inventory",),
                "terms": (
                    "archive",
                    "zip",
                    "rar",
    ...
    },
    {
        ...
        "capabilities": (
            {"id": "kakaotalk-windows-app-database", "label": "PC KakaoTalk Windows DB", "status": "partial", "terms": ("kakao", "kakaotalk", "chatlogs", "edb")},
            {
                ...
                "status": "partial",
                "artifact_types": ("kakaotalk-macos-database", "kakaotalk-macos-summary"),
            ...
            {"id": "mobile-message", "label": "모바일 메시지/SMS/통화", "status": "partial", "terms": ("mobile", "sms", "call", "contact", "message")},
            {
                ...
                "status": "partial",
                "artifact_types": ("mobile-message", "mobile-chat-database"),
                "terms": (
                    "whatsapp",
                    "telegram",
                    "signal",
                    "line",
                    "discord",
                    "chat_app_forensic_review",
                    "messenger-export-framework-manifest",
                ),
            },
        ),
    },
    {
        ...
        "capabilities": (
            {"id": "cloud-google-takeout", "label": "Google Takeout", "status": "partial", "terms": ("takeout", "gmail", "drive", "photos", "location")},
            {
                ...
                "label": "iCloud export",
                "status": "partial",
                "artifact_types": ("cloud-account", "cloud-file", "cloud-location"),
            ...
            },
            {
                ...
                "status": "partial",
                "artifact_types": ("cloud-message", "cloud-file", "cloud-audit"),
    ...
    },
    {
        ...
        "capabilities": (
            ...
            {"id": "dfir-powershell-lol", "label": "PowerShell/LoL/Fileless", "status": "partial", "terms": ("powershell", "wmi", "wmic", "lol", "fileless")},
            {
                ...
                "status": "partial",
                "artifact_types": ("webshell-source-candidate", "web-server-log"),
                "terms": (
                    "webshell",
                    "iis",
                    "apache",
                    "nginx",
                    "domain",
                    "webshell-source-candidate",
                    "web-server-log",
                    "webshell_semantic_profile",
                    "webshell_log_correlation",
                    "webshell_report_citation_package",
                ),
            },
        ),
    },
    {
        ...
        "capabilities": (
            {"id": "evidence-vss-apfs-snapshot", "label": "VSS/APFS 스냅샷", "status": "partial", "terms": ("vss", "shadow copy", "apfs snapshot", "snapshot", "recovery_unlock_profile", "snapshot_workflow")},
            {
                ...
                "next_action": "Use the FDE operator runbook to collect lawful key/export proof, then rerun RapidTriage on the decrypted root.",
            },
    ...
    },
    {
        ...
        "capabilities": (
            ...
            {"id": "recycle-bin-ir-map", "label": "Recycle Bin $I/$R 매핑", "status": "partial", "terms": ("recycle bin", "recycle-bin-entry", "$i", "$r", "deleted time", "original path")},
            {
                ...
                "status": "partial",
                "artifact_types": ("ads-stream-candidate",),
                "terms": (
                    "ads",
    ...
    },
    {
        ...
        "capabilities": (
            ...
            {"id": "denisting-nsrl-whitelist", "label": "De-NISTing/Whitelisting", "status": "partial", "terms": ("nsrl", "nsrl-rds-csv", "nsrlfile.txt", "nsrl-rds.zip", "denist", "whitelist", "known file", "known-good-index", "known_good_suppression_profile", "known_good_search_suppression_profile")},
