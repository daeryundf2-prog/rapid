...
class RapidTriageApiTests(unittest.TestCase):
    ...
    def test_web_console_exposes_maestro_style_artifact_workbench(self) -> None:
        ...
        self.assertIn("IMAGE_EVIDENCE_FORMATS", app_js)
        self.assertIn("detectEvidenceImageKind", app_js)
        self.assertIn("isLikelyImageEvidencePath", app_js)
        ...
        self.assertIn("FORENSIC_WORKFLOW_LANES", config_js)
        ...
        self.assertIn("renderWorkflowLaneBoard", app_js)
        self.assertIn("renderEvidenceSourceNavigator", app_js)
        self.assertIn("renderAdaptiveViewerHeader", app_js)
        self.assertIn("renderIntelligencePanel", app_js)
        ...
        self.assertIn("data-testid=\"forensic-workflow-lanes\"", app_js)
        self.assertIn("data-testid=\"evidence-source-stack\"", app_js)
        self.assertIn("data-testid=\"adaptive-evidence-viewer\"", app_js)
        self.assertIn("data-testid=\"intelligence-panel\"", app_js)
        ...
        self.assertIn("disk-image-derived", index_html)
        self.assertIn("archive-image-derived", index_html)
