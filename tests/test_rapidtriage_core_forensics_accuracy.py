...
class RapidTriageCoreForensicsAccuracyTests(unittest.TestCase):
    ...
    def test_specific_accuracy_profiles_capture_high_risk_requirements(self) -> None:
        ...
        self.assertIn("legal limitation report-grade validation plan", legal_limitation["required_checks"])
        ...
        self.assertIn("local-only report-grade validation plan", local_only["required_checks"])
        ...
        self.assertIn("collaboration audit report-grade validation plan", collaboration_audit["required_checks"])
        ...
        self.assertIn("support SLA report-grade validation plan", support_sla["required_checks"])
        ...
        self.assertIn("quickstart lab report-grade validation plan", quickstart["required_checks"])
